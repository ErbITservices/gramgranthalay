...
function Motibhaiamin_2() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const senddata = await fetch(`http://localhost:5555/Motibhaiamin2/`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify({
          lname: library[0].lname,
          gam: library[0].gam,
          uid: library[0].uid,
          marks: count,
        }),
          ...
          {library.length != 0 && (
            <div>
              ...
              <div className="row mb-3 col-sm-13 align-items-center">
                ...
                <div className="col">
                  ...
                  >
                    ...
                    <option value={0}>
                      ગ્રંથાલય વિજ્ઞાન ની લાયકાત ન હોય તો
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div className="row mb-3 col-sm-13 align-items-center">
                ...
                <div className="col">
                  ...
                  >
                    ...
                    <option value={2}>
                      101 થી 200 પુસ્તકો ઉમેરાયેલ હોય તો
                    </option>
              ...
              <div className="row mb-3 col-sm-13 align-items-center">
                ...
                <div className="col">
                  ...
                  >
                    ...
                    <option value={1}>
                      અગ્રંથ વાંચન સામગ્રી પૂરતી ન હોય તો
                    </option>
              ...
              <div className="row mb-3 col-sm-13 align-items-center">
                <div className=" col">
                  <label className="col-sm-10 col-form-label">
                    વેકેશનમાં બાળકો માટે અપાતી સેવાઓ કે થતી પધ્ધતિઓ અંગેની
                    વિગતો:
                  </label>
                </div>
                <div className="col">
              ...
              <div className="row mb-3 col-sm-13 align-items-center">
                ...
                <div className="col">
                  ...
                  >
                    ...
                    <option value={3}>
                      વાર્ષિક લવાજમ ૧ થી ૨૫ સુધી લેવાય તો
                    </option>
              ...
              <div className="row mb-3 col-sm-13 align-items-center">
                ...
                <div className=" col">
                  <label className="col-sm-10 col-form-label">
                    ગ્રંથાલય દ્વારા અપાતી વિશિષ્ટ સેવાઓ/પ્રવૃત્તિ ઉલ્લેખપાત્ર
                    કોઈ વિશેષતા કે પધ્ધતી હોય તો તેની વિગતો :
                  </label>
                </div>
                <div className="col">
                  <select
              ...
              <div className="row mb-3 col-sm-13 align-items-center">
                <div className=" col">
                  <label className="col-sm-10 col-form-label">
                    ગ્રંથાલયના વિકાસ માટે વ્યવસ્થા થી ધગશ અને નવીન વિકાસ યોજના
                    કોઈ એક હોયતે તેની વિગત:
                  </label>
                </div>
                <div className="col">
                  <select
                  ...
                  >
                    ...
                    <option value={1}>
                      યોજના હોય પણ સંતોષકારક પ્રગતિ ન હોય
                    </option>
